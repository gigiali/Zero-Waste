    ...
    <div className="profile-page">
      ...
      <div className="profile-body">
        <div className="profile-card">
          ...
          {message && <span style={{ color: message.includes("success") ? "#10b981" : "#ef4444", fontSize: "0.85rem", marginTop: "1rem" }}>{message}</span>}
          <button
            onClick={handleSave}
            disabled={isLoading}
            style={{
              marginTop: "1.5rem", padding: "0.75rem", width: "100%",
              background: isLoading ? "#9ca3af" : "#10b981",
