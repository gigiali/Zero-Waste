...
export default function Favorites() {
  ...
  const getLat = () => locationCoords?.lat || 30.0444;
  const getLng = () => locationCoords?.lng || 31.2357;
  ...
  const fetchFavorites = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        // each vendor has: { id, business_name, logo, branches: [{ distance, offers: [...] }] }
      ...
      <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "2rem 1.5rem" }}>
        ...
        {!isLoading && error && (
          <div style={{ background: "#fef2f2", border: "1px solid #fecaca", borderRadius: "10px", padding: "1rem 1.5rem", color: "#dc2626", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <span>{error}</span>
            <button onClick={fetchFavorites} style={{ background: "#dc2626", color: "white", border: "none", borderRadius: "6px", padding: "6px 14px", cursor: "pointer", fontSize: "0.85rem" }}>
              Retry
            </button>
          </div>
        )}
        ...
        {!isLoading && !error && favorites.length === 0 && (
          <div style={{ textAlign: "center", padding: "5rem 2rem" }}>
            ...
            <button
              ...
              style={{ background: "#10b981", color: "white", border: "none", borderRadius: "8px", padding: "0.75rem 1.5rem", fontWeight: 600, cursor: "pointer", fontSize: "0.95rem" }}
            >
              Explore Restaurants
            </button>
          </div>
        ...
        {/* Grid — each item is a vendor directly from API */}
        {!isLoading && !error && favorites.length > 0 && (
