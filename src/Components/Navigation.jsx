...
export default function Navigation({
  ...
  useEffect(() => {
    const handleLanguageChanged = (lng) => setSelectedLanguage(String(lng).toUpperCase());
            ...
            isLoggedIn ? (
              <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
                ...
                <button onClick={() => setShowLogoutConfirm(true)}
                  style={{ display: "flex", alignItems: "center", gap: "0.4rem", background: "none", border: "1.5px solid #ef4444", color: "#ef4444", borderRadius: "8px", padding: "0.4rem 0.8rem", cursor: "pointer", fontSize: "0.85rem", fontWeight: 600 }}>
                  Log Out
                </button>
              </div>
            ) : (
          ...
          <div style={{ background: "white", borderRadius: "12px", width: "90%", maxWidth: "800px", height: "70vh", position: "relative", overflow: "hidden", boxShadow: "0 20px 60px rgba(0,0,0,0.3)" }}>
            <div style={{ padding: "1rem 1.5rem", borderBottom: "1px solid #e5e7eb" }}>
              ...
              <div style={{ position: "relative" }}>
                ...
                <input type="text" placeholder="Search for a city, area..."
                  value={mapSearchQuery} onChange={handleMapSearchInput}
